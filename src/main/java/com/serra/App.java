...
public class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        stage.getIcons().add(new Image(App.class.getResource("images/icon.jpg").toExternalForm()));
        ...
        sm.setScene(SceneID.MAIN, "MainView", 600, 900);
        sm.setScene(SceneID.SECONDARY, "SecondaryView", 600, 200);
